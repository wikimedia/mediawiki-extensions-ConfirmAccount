...
כשהחשבון יאושר, תישלח אליכם הודעה בדואר האלקטרוני ותוכלו [[Special:UserLogin|להיכנס אליו]].",
	...
	'confirmedit-desc' => 'הענקת היכולת לבירוקרטים לאשר בקשות לחשבונות',
	...
	'confirmaccount-q-held' => 'בקשות מעוכבות',
	...
	'confirmaccount-leg-person' => 'נתונים אישיים',
	'confirmaccount-leg-other' => 'נתונים אחרים',
	...
	'confirmaccount-none-p' => '(לא צויין)',
	...
	'confirmaccount-deny' => 'דחיה (מחיקת הבקשה)',
	'confirmaccount-hold' => 'עיכוב',
	'confirmaccount-spam' => 'זבל (ללא שליחת הודעה בדוא"ל)',
	'confirmaccount-reason' => 'הערה (תכלל בהודעת הדוא"ל):',
