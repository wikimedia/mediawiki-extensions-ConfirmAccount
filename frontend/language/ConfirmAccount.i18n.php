 ...
 */
$messages['qqq'] = array(
	'confirmaccount-newrequests' => 'Notice for account reviewers when there are account requests from users with a confirmed email address.

Parameters:
* $1 - the number of open account requests matching given criteria',
 ...
 */
$messages['ksh'] = array(
	'confirmaccount-newrequests' => '{{PLURAL:$1|Ein|\'\'\'$1\'\'\'|Kein}} unjedonn [[Special:ConfirmAccounts|{{PLURAL:$1|Aanfrooch|Aanfroore|Aanfrohre}}]] met beschtääteschte <i lang="en">e-mail</i>-Addräß {{PLURAL:$1|es|sen|sin}} am waade.',
...
$messages['roa-tara'] = array(
	'confirmaccount-newrequests' => "'''$1''' iapre l'email de conferme  [[Special:ConfirmAccounts|pe {{PLURAL:$1|'a richieste appese|le richieste appise}} de cunde]]. '''Pe piacere fà attenziò!'''",
	...
	'right-requestips' => "'Ndruche l'indirizze IP de le cercature mendre ca ste processe le richieste de cunde",
