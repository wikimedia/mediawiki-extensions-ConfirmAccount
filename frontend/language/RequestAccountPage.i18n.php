...
هنگامی که حساب تأیید شد، به شما یک پیغام اعلان رایانامه خواهد شد و حساب در [[Special:UserLogin|login]] قابل استفاده خواهد بود.",
	...
	'requestaccount-acc-text' => 'هنگامی که شما این درخواست را ارائه می‌کنید، یک پیغام تأییدیه به آدرس رایانامهٔ شما فرستاده خواهد شد.
...
مطمئن شوید که در انتشار از جمله اطلاعات آسوده هستید.",
	...
	'requestaccount-agree' => 'شما باید نام واقعی خود را که درست است، و اینکه شما با شرایط سرویس ما موافقید را تأیید کنید.',
...
یک رایانامهٔ تأیید به آدرس رایانامهٔ شما فرستاده شده‌است.',
	'request-account-econf' => 'نشانی رایانامهٔ شما تأیید شده‌است و به این‌ صورت در درخواست حسابتان فهرست خواهد‌شد.',
...
این کد تأییدیه در $4 منقضی خواهد‌شد.',
	'requestaccount-email-subj-admin' => 'درخواست حساب {{SITENAME}}',
	'requestaccount-email-body-admin' => '«$1» یک حساب درخواست کرده‌است و برای تأییدیه در حال انتظار است.
این نشانی رایانامه تأیید شده‌است. شما می‌توانید درخواست را اینجا «$2» تأیید کنید.',
