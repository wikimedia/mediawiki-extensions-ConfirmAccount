...
$messages['ast'] = array(
	...
	'requestaccount-text' => "'''Complete y unvie'l siguiente formulariu pa solicitar una cuenta d'usuariu'''.

Antes de solicitar una cuenta, asegúrese de lleer primero les [[{{MediaWiki:Requestaccount-page}}|condiciones del serviciu]].

Cuando s'apruebe la cuenta, unviaráse un mensaxe de notificación per corréu electrónicu y la cuenta podrá usase [[Special:UserLogin|aniciando sesión]].",
	'requestaccount-page' => '{{ns:project}}:Condiciones de serviciu',
	'requestaccount-dup' => "'''Nota: Yá anició sesión con una cuenta rexistrada.'''",
	'requestaccount-leg-user' => "Cuenta d'usuariu",
	'requestaccount-leg-areas' => "Principales árees d'interés",
...
Seique quiera proporcionar contautos como un númberu de teléfonu p'ayudar na confirmación de la identidá.",
	'requestaccount-bio-text' => 'Intente incluir dalgunes acreditaciones relevantes na so biografía más abaxo.',
	'requestaccount-bio-text-i' => "'''La so biografía quedará configurada como'l conteníu inicial de la so páxina d'usuariu.'''
Asegúrese de que nun tien problema en publicar esa información.",
	'requestaccount-real' => 'Nome real:',
	'requestaccount-same' => "(el mesmu que'l nome real d'abaxo)",
	'requestaccount-email' => 'Direición de corréu electrónicu:',
	'requestaccount-reqtype' => 'Cargu:',
...
Пасьля стварэньня рахунку, Вам будзе дасланы ліст па электроннай пошце з паведамленьнем і Вы зможаце [[Special:UserLogin|ўвайсьці ў сыстэму]].",
	...
	'requestaccount-acc-text' => 'Пасьля адпраўкі запыту на Ваш адрас электроннай пошты будзе дасланы ліст з пацьверджаньнем. Гэты адрас ня будзе агалошаны.
...
$messages['fa'] = array(
	...
	'requestaccount-text' => "'''فرم زیر را برای درخواست یک حساب کامل و ارائه کنید.'''
مطمئن شوید که پیش از درخواست یک حساب،اول [[{{MediaWiki:Requestaccount-page}}|Terms of Service]] را می‌خوانید.
هنگامی که حساب تایید شد، به شما یک پیغام اعلان رایانامه خواهد شد و حساب در [[Special:UserLogin|login]] قابل استفاده خواهد بود.",
	'requestaccount-page' => '{{ns:project}}: شرایط استفاده از خدمات',
	'requestaccount-dup' => "'''توجه: پیش از این شما با یک حساب ثبت‌نام شده وارد شده‌اید.",
	'requestaccount-leg-user' => 'حساب کاربری',
	'requestaccount-leg-areas' => 'زمینه‌های مورد‌علاقهٔ اصلی',
	'requestaccount-leg-person' => 'اطلاعات شخصی',
	'requestaccount-leg-other' => 'اطلاعات دیگر',
	'requestaccount-leg-tos' => 'شرایط خدمات',
	'requestaccount-acc-text' => 'هنگامی که شما این درخواست را ارائه می‌کنید، یک پیغام تاییدیه به آدرس رایانامهٔ شما فرستاده خواهد شد.
آدرس منتشر نخواهد شد.
لطفاً با کلیک کردن بر روی پیوند تأیید ارائه شده توسط رایانامه، پاسخ دهید.
در نهایت، هنگامی که حساب شما ایجاد شد، رمز عبورتان به شما رایانامه‌ خواهد‌شد.',
	'requestaccount-areas-text' => ' از زیرحیطه‌های موضوعی را انتخاب کنید که مهارت شما در آن به رسمیت شناخته شده یا می‌خواهید در آن بیشتر کار کنید.',
	'requestaccount-ext-text' => 'اطلاعات زیر به صورت محرمانه نگهداری شده و فقط برای این درخواست استفاده خواهد‌شد.
ممکن است شما بخواهید تماس‌هایی را مانند یک شماره تلفن برای کمک به شناسایی اطلاعات، فهرست کنید.',
	'requestaccount-bio-text' => 'برای شامل کردن هر اعتبارنامهٔ مطابق با شرح‌حال‌تان در زیر امتحان کنید.',
	'requestaccount-bio-text-i' => "'''شرح‌حال شما به عنوان مضمون اولیه برای صفحهٔ کاربری‌تان تنظیم خواهد شد.'''
مطمئن شوید که در انتشار از جمله اطلاعات آسوده هستید.",
	'requestaccount-real' => 'نام واقعی:',
	'requestaccount-same' => '(همان نام واقعی)',
	'requestaccount-email' => 'نشانی رایانامه:',
	'requestaccount-reqtype' => 'موقعیت:',
	'requestaccount-level-0' => 'مؤلف',
	'requestaccount-level-1' => 'ویرایشگر',
	'requestaccount-bio' => 'شرح‌حال شخصی (فقط متن واضح):',
	'requestaccount-attach' => 'رزومه یا سی‌وی (اختیاری):',
	'requestaccount-notes' => 'یادداشت‌های اضافی:',
	'requestaccount-urls' => 'فهرست وب سایت ها، اگر هرگونه (هرکدام بر روی یک خط مجزا)',
	'requestaccount-agree' => 'شما باید نام واقعی خود را که درست است،و اینکه شما با شرایط سرویس ما موافقید را تایید کنید.',
	'requestaccount-inuse' => 'در حال حاضر نام کاربری در یک درخواست حساب در حال انتظار مورد استفاده  است.',
	'requestaccount-tooshort' => 'شرح‌حال شما باید دارای حداقل طول  $1 {{PLURAL:$1|word|words}} باشد.',
	'requestaccount-emaildup' => 'درخواست حساب در حال انتظار دیگری از آدرس رایانامهٔ مشابهی استفاده می کند.',
	'requestaccount-exts' => 'نوع پوشهٔ‌ پیوست مجاز نیست.',
	'requestaccount-resub' => 'پوشهٔ سی‌وی/رزومه شما به دلایل امنیتی باید دوباره انتخاب شود.
اگر دیگر نمی‌خواهید یکی را شامل کنید، زمینه را خالی رها کنید.',
	'requestaccount-tos' => 'من خوانده‌ام و می‌پذیرم که توسط [[{{MediaWiki:Requestaccount-page}}|Terms of Service]] از {{SITENAME}} متحمل شوم.
نامی را که تحت "نام واقعی" تعیین کرده‌ام،در حقیقت نام واقعی خود من است.',
	'requestaccount-submit' => 'درخواست حساب',
	'requestaccount-sent' => 'درخواست حساب شما با موفقیت فرستاده شد و اکنون در حال انتظار بررسی است.
یک رایانامهٔ تایید به آدرس رایانامهٔ شما فرستاده شده‌است.',
	'request-account-econf' => 'آدرس رایانامهٔ شما تایید شده‌است و به این‌ صورت در درخواست حسابتان فهرست خواهد‌شد.',
	'requestaccount-email-subj' => 'تأیید نشانی رایانامه {{SITENAME}}',
	'requestaccount-email-body' => 'کسی ممکن است از آدرس آی‌پی $1 شما، برای حساب «$2» با این آدرس رایانامه در {{SITENAME}} درخواست داده باشد.
برای تایید اینکه این حساب درحقیقت به شما در {{SITENAME}} تعلق دارد، این پیوند را در مرورگر خود باز کنید:
$3
اگر حساب ایجاد شده باشد، به شما فقط رمز عبور،رایانامه خواهد شد.
اگر به شما تعلق ندارد، پیوند زیر را دنبال نکنید.
این کد تاییدیه در $4 منقضی خواهد‌شد.',
	'requestaccount-email-subj-admin' => 'درخواست حساب {{SITENAME}}',
	'requestaccount-email-body-admin' => '"$1" یک حساب درخواست کرده‌است و برای تاییدیه در حال انتظار است.
این آدرس رایانامه تایید شده‌است. شما می‌توانید درخواست را اینجا "$2" تایید کنید.',
	'acct_request_throttle_hit' => 'با عرض پوزش، در حال حبضر شما {{PLURAL:$1|1 account|$1 accounts}} را درخواست کرده‌اید.
شما نمی‌توانید بیش از این درخواست داشته باشید.',
);
...
Voit muuttaa nimeäsi [[Special:Preferences|asetussivulla]].', # Fuzzy
	...
	'requestaccount-bio' => 'Kuvaus itsestäsi (vain teksti):',
...
Unha vez aprobada a conta, recibirá unha mensaxe de notificación por correo electrónico e poderá usar a conta [[Special:UserLogin|accedendo ao sistema]].",
	'requestaccount-page' => '{{ns:project}}:Termos de servizo',
	'requestaccount-dup' => "'''Nota: Xa accedeu ao sistema cunha conta rexistrada.'''",
...
Ten a posibilidade listar contactos, como un número de teléfono, para axudar na confirmación da identidade.',
	...
	'requestaccount-bio-text-i' => "'''A súa biografía quedará establecida como o contido inicial da súa páxina de usuario.'''
Asegúrese de que se sinte cómodo publicando esa información.",
	...
	'requestaccount-urls' => 'Lista de sitios web, se houbese algún (un por liña):',
	'requestaccount-agree' => 'Debe certificar que o seu nome real é correcto e que está de acordo cos nosos termos de servizo.',
	'requestaccount-inuse' => 'Este nome de usuario xa se usou nunha solicitude de conta que aínda está pendente.',
	'requestaccount-tooshort' => 'A súa biografía debe ter un mínimo {{PLURAL:$1|dunha palabra|de $1 palabras}}.',
	'requestaccount-emaildup' => 'Outra solicitude pendente usa o mesmo enderezo de correo electrónico.',
	'requestaccount-exts' => 'O tipo de ficheiro do anexo non está permitido.',
	'requestaccount-resub' => 'Ten que volver seleccionar o ficheiro do seu currículo por razóns de seguridade.
Deixe o campo en branco se xa non o quere incluír.',
	'requestaccount-tos' => 'Lin e acepto os [[{{MediaWiki:Requestaccount-page}}|termos de servizo]] de {{SITENAME}}.
O nome especificado como "Nome real" é, efectivamente, o meu nome real.',
	'requestaccount-submit' => 'Solicitar a conta',
...
Envióuselle un correo electrónico de confirmación ao seu enderezo de correo electrónico.',
	'request-account-econf' => 'Confirmouse o seu enderezo de correo electrónico e listarase como tal na súa solicitude de conta.',
	'requestaccount-email-subj' => 'Confirmación do enderezo de correo electrónico de {{SITENAME}}',
...
$messages['hi'] = array(
	...
	'requestaccount-email' => 'ई-मेल पता:',
...
この情報を公開していいか確認してください。",
	...
	'requestaccount-attach' => '履歴書または CV (省略可能):',
	...
	'requestaccount-tooshort' => "経歴には単語が少なくとも $1 個必要です。''(訳注: この機能は日本語版ではうまく動作しないかもしれません。あなたが管理者である場合は、この制約の使用に慎重であってください。あなたが一般利用者である場合は、このサイトの管理者と相談してください。)''",
...
この {{SITENAME}}　のアカウントが本当にあなたのものか確認するために、以下のリンクをブラウザーで開いてください:

$3

アカウントが作成されると、あなたのみにパスワードをメールでお送りします。
もしも、この申請があなたによるもの\'\'\'ではない\'\'\'場合、このリンクをクリックしないでください。
...
$messages['ka'] = array(
	...
	'requestaccount-leg-tos' => 'გამოყენების წესები',
	'requestaccount-real' => 'ნამდვილი სახელი:',
	'requestaccount-same' => '(იგივე რაც ნამდვილი სახელი ქვევით)',
...
Sobald De ene Zohjang kräje häß, kriß De en <i lang=\"en\">e-mail</i> jescheck, un Do kanns Desch hee [[Special:UserLogin|enlogge]].",
	...
	'requestaccount-bio-text-i' => "'''Dä Täx övver Ding Levve weed för der Aanfang op Ding Metmaachersigg jeschtallt.'''
Bes sescher, dat de Desh joot föhls domet, dat öffentlesch ze maache.",
	...
	'requestaccount-bio' => 'Ding Levve beß jäz (nor jewöhnlijje Täx):',
...
Штом ќе ви биде одобрена сметката, ќе ви биде испратено известување по е-пошта и тогаш ќе можете да [[Special:UserLogin|се најавите]] и да ја користите.",
	...
	'requestaccount-acc-text' => 'Откако ќе го поднесете барањето, ќе добиете потврдна порака по е-пошта.
Одговорете со тоа што ќе стиснете на потврдната врска во пораката.
 ...
 */
$messages['mt'] = array(
	'requestaccount' => 'Itlob kont',
	'requestaccount-text' => "'''Kompli u ibgħat il-formola segwenti sabiex titlob kont tal-utent'''.

Kun żgur li l-ewwel taqra t-[[{{MediaWiki:Requestaccount-page}}|termini tas-servizz]] qabel ma titlob għal kont.

Ġaladarba l-kont jiġi approvat, se tintbagħtlek ittra elettronika b'messaġġ ta' notifika u l-kont jista' jiġi wżat fil-[[Special:UserLogin|login]]",
	'requestaccount-page' => '{{ns:project}}:Termini tas-servizz',
	'requestaccount-dup' => "'''Nota: Inti diġà tinsab f'kont reġistrat.'''",
	'requestaccount-leg-user' => 'Kont tal-utent',
	'requestaccount-leg-areas' => "Irkejjen prinċipali ta' interess",
	'requestaccount-leg-person' => 'Informazzjoni personali',
	'requestaccount-leg-other' => 'Informazzjoni oħra',
...
Tista' ddaħħal kuntatti bħan-numru tat-telefown sabiex jgħinu fl-identifikazzjoni.",
	'requestaccount-bio-text' => 'Ipprova inkludi l-kredenzjali u l-informazzjoni rilevanti fil-bijografija tiegħek.',
	'requestaccount-bio-text-i' => "'''Il-bijografija tiegħek se tiġi imposta bħala l-kontenut oriġinali għall-paġna tal-utent tiegħek.'''
Kun żgur li inti tixtieq tippubblika din l-informazzjoni.",
	'requestaccount-real' => 'Isem proprju:',
	'requestaccount-same' => '(l-istess bħall-isem proprju)',
	'requestaccount-email' => 'Indirizz elettroniku:',
	'requestaccount-reqtype' => 'Pożizzjoni:',
	'requestaccount-level-0' => 'awtur',
	'requestaccount-level-1' => 'editur',
	'requestaccount-bio' => 'Bijografija personali (test biss):',
	'requestaccount-attach' => 'Kurrikulu (opzjonali):',
	'requestaccount-notes' => 'Noti oħra:',
	'requestaccount-urls' => "Lista ta' websajts, jekk hemm (waħda f'kull linja):",
	'requestaccount-agree' => 'Trid tiċċertifika li l-isem proprju tiegħek huwa tajjeb u li taqbel mat-termini tas-servizz.',
	'requestaccount-inuse' => "L-isem tal-utent qiegħed diġa jintuża f'rikjesta oħra għal kont.",
	'requestaccount-tooshort' => 'Il-bijografija tiegħek trid tkun twila minn tal-anqas {{PLURAL:$1|kelma|$1 kelma}}.',
	'requestaccount-emaildup' => 'Rikjesta oħra għal kont qiegħdha tuża l-istess indirizz elettroniku.',
	'requestaccount-exts' => "It-tip ta' fajl mehmuż mhuwiex permess.",
	'requestaccount-resub' => "Il-fajl tal-kurrikulu tiegħek għandu jerġa' jiġi magħżul għal raġunijiet ta' sigurtà.
Ħalli l-qasam vojt jekk ma tridx tinkludi wieħed.",
	'requestaccount-tos' => 'Jiena qrajt u qbilt li nirrispetta t-[[{{MediaWiki:Requestaccount-page}}|termini tas-servizz]] ta\' {{SITENAME}}.
L-isem li tajt taħt "Isem proprju" huwa fil-fatt il-veru isem tiegħi.',
	'requestaccount-submit' => 'Itlob il-kont',
	'requestaccount-sent' => "Ir-rikjesa tiegħek għal kont intbagħet b'suċċess u issa qiegħdha tiġi verifikata.
Messaġġ ta' konferma se tintbagħtlek fl-indirizz elettroniku tiegħek.",
	'request-account-econf' => 'L-indirizz elettroniku tiegħek ġie kkonfermat u se jiġi mniżżel bħala tali fir-rikjesta tiegħek għal kont.',
	'requestaccount-email-subj' => 'Konferma tal-indirizz elettroniku għal {{SITENAME}}',
	'requestaccount-email-body' => 'Xi ħadd, probabbilment int mill-indirizz IP $1, talab għall-kont "$2" b\'dan l-indirizz tal-posta elettronika fuq {{SITENAME}}.

Biex tikkonferma li dan il-kont tassew jappartjeni għalik, iftaħ il-ħolqa segwenti:

$3

Meta l-kont jiġi maħluq, il-password se tintbagħat lilek biss permezz tal-posta elettronika.
Jekk il-kont *mhuwiex* tiegħek, issegwix il-ħolqa.
Dan il-kodiċi ta\' konferma se jiskadi fil-$4.',
	'requestaccount-email-subj-admin' => 'Rikjesta għal kont fuq {{SITENAME}}',
	'requestaccount-email-body-admin' => '"$1" talab kont u qiegħed jistenna konferma.
L-indirizz elettroniku ġie kkonfermat. Tista\' tikkonferma r-rikjesta hawnhekk "$2".',
	'acct_request_throttle_hit' => 'Jiddispjaċina, inti diġà tlabat għal {{PLURAL:$1|kont wieħed|$1 kontijiet}}.
Ma tistax tagħmel iktar rikjesti.',
);
...
[[Special:UserLogin|использовать для авторизации]].",
	...
	'requestaccount-dup' => "'''Замечание. Вы уже представились системе с зарегистрированной учётной записи.'''",
	...
	'requestaccount-acc-text' => 'После того, как вы отправите эту заявку, на ваш адрес будет отправлено письмо с подтверждением. Ваш адрес электронной почты не будет нигде опубликован.
Для подтверждения нажмите, пожалуйста, на ссылку в пришедшем письме.
Пароль будет отправлен вам по почте после того, как ваша учётная запись будет создана.',
...
$messages['si'] = array(
	...
	'requestaccount-page' => '{{ns:project}}:සේවාවේ කොන්දේසි',
	'requestaccount-dup' => "'''සටහන: ඔබ දැනටමත් ලියාපදිංචි කරන ලද ගිණුමකින් ප්‍රවිෂ්ට වී ඇත.'''",
	'requestaccount-leg-user' => 'පරිශීලක ගිණුම',
	'requestaccount-leg-areas' => 'ඇල්මේ ප්‍රධාන පැති',
	...
	'requestaccount-same' => '(පහත දැක්වෙන සැබෑ නාමය වගේම)',
	...
	'requestaccount-email-subj-admin' => '{{SITENAME}} ගිණුම් අයදුම',
);
...
Мутмани бошед, ки шумо аввал [[{{MediaWiki:Requestaccount-page}}|Шартҳои Хидматро]] қабл аз дархости ҳисоб хондаед.

Дар ҳоли тасдиқ шудани ҳисоб, паёми огоҳсозӣ тариқи почтаи электронӣ ба шумо фиристода хоҳад шуд ва ҳисоби шумо дар [[Special:UserLogin|вуруд]] 
қобили истифода хоҳад шуд.",
...
Номи мушаххаскардаи ман зери "Номи Аслӣ" дар ҳақиқат номи аслии худи ман аст.',
	...
	'requestaccount-sent' => 'Дархости шумо бо муваффақият фиристода шуд ва ҳамакнун дар ҳоли баррасӣ аст.
	Як пайёми электронии тасдиқкунанда ба нишонаи электронии шумо фиристода шуд.',
...
Нишонаи почтаи электронӣ тасдиқ шуд. Шумо дархостро метавонед инҷо "$2" тасдиқ кунед.',
	'acct_request_throttle_hit' => 'Бубахшед, шумо аллакай {{PLURAL:$1|1 ҳисоб|$1 ҳисоб}} дархост кардаед.
Шумо аз ин зиёд дархост карда наметавонед.',
);
...
Переконайтесь, що Ви не проти публікації такої інформації.",
	...
	'requestaccount-same' => "(таке саме, як справжнє ім'я нижче)",
	...
	'requestaccount-attach' => "Резюме або CV (необов'язково):",
	'requestaccount-notes' => 'Додаткова інформація:',
	'requestaccount-urls' => 'Список веб-сайтів, якщо є (кожен в окремому рядку):',
	'requestaccount-agree' => "Ви повинні підтвердити, що ваше справжнє ім'я є правильним та що ви згодні з нашими Умовами надання послуг.",
	'requestaccount-inuse' => "Ім'я користувача вже вказане в одному із запитів на обліковий запис.",
	'requestaccount-tooshort' => 'Ваша біографія повинна містити не менше $1 {{PLURAL:$1|слова|слів}}.',
	'requestaccount-emaildup' => 'В іншому незавершеному запиті на обліковий запис вказана така сама адреса електронної пошти.',
	'requestaccount-exts' => 'Недозволений тип прикріпленого файлу.',
	'requestaccount-resub' => 'Ваш файл з CV/резюме треба вибрати повторно з міркувань безпеки.
Залиште поле пустим, якщо ви не хочете його відправляти.',
	'requestaccount-tos' => "Я прочитав (-ла) і згоден (-на) виконувати [[{{MediaWiki:Requestaccount-page}}|Умовами надання послуг]] {{SITENAME}}.
Ім'я, вказане в полі «Справжнє ім'я», насправді є моїм справжнім іменем.",
	'requestaccount-submit' => 'Надіслати запит облікового запису',
	'requestaccount-sent' => 'Ваш запит на обліковий запис успішно надіслано і зараз очікує розгляду.
Лист з підтвердженням було надіслано на вашу електронну адресу.',
	'request-account-econf' => 'Ваша адреса електронної пошти була підтверджена і буде вказана у вашому запиті на обліковий запис.',
	'requestaccount-email-subj' => '{{SITENAME}}: підтвердження електронною поштою',
	'requestaccount-email-body' => 'Хтось (вірогідно, Ви) з IP-адреси $1 подав запит на обліковий запис «$2» на сайті {{SITENAME}} з цією адресою електронної пошти.

Щоб підтвердити, що цей обліковий запис на сайті {{SITENAME}} дійсно належить Вам, перейдіть за цим посиланням у своєму браузері:

$3

Якщо обліковий запис буде створено, тільки Вам буде надіслано пароль.
Якщо це *не* Ви, не переходьте за посиланням.
Цей код підтвердження дійсний до $4.',
	'requestaccount-email-subj-admin' => '{{SITENAME}}: запит облікового запису',
	'requestaccount-email-body-admin' => '«$1» подав запит на обліковий запис і чекає на підтвердження.
Адресу електронної пошти підтверджено. Ви можете погодити запит тут «$2».',
	'acct_request_throttle_hit' => 'Вибачте, ви уже подали запит на {{PLURAL:$1|1 обліковий запис|$1 облікові записи|$1 облікових записів}}.
Ви більше не можете подавати запити.',
);
