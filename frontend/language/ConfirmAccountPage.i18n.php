...
It may have already been handled.',
	...
	'confirmaccount-reject'   => '({{GENDER:$1|rejected}} by [[User:$1|$1]] on $2)',
	...
	'confirmaccount-held'     => '({{GENDER:$1|marked}} "on hold" by [[User:$1|$1]] on $2)',
...
Wenn du diese Seite verlässt, ohne das Konto zu bestätigen oder abzulehnen, wird der Antrag offen stehen bleiben.",
	...
	'confirmaccount-reject' => '({{GENDER:$1|abgelehnt}} durch [[User:$1|$1]] am $2)',
	...
	'confirmaccount-held' => '({{GENDER:$1|markiert}} als „abwarten“ durch [[User:$1|$1]] am $2)',
