...
Si vous quittez cette page sans confirmer ou rejeter cette demande, elle restera en attente.",
	...
	'confirmaccount-reject' => '({{GENDER:$1|rejeté}} par [[User:$1|$1]] le $2)',
	...
	'confirmaccount-held' => '({{GENDER:$1|marqué}} "réservé" par [[User:$1|$1]] le $2)',
...
Можно е барањето веќе да е обработено.',
	...
	'confirmaccount-reject' => '({{GENDER:$1|одбиено}} од [[User:$1|$1]] на $2)',
	...
	'confirmaccount-held' => '({{GENDER:$1|обележано}} како „на чекање“ од [[User:$1|$1]] на $2)',
...
S'a lassrà sta pàgina-sì sensa confirmé o scancelé st'arcesta, a restrà an cors.",
	...
	'confirmaccount-reject' => '({{GENDER:$1|arfudà}} da [[User:$1|$1]] dël $2)', # Fuzzy
	...
	'confirmaccount-held' => '({{GENDER:$1|marcà}} "an coa" da [[User:$1|$1]] dël $2)', # Fuzzy
